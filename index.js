...
const cssModuleToNamedExports = (cssModuleKeys, { camelCase }) => {
  return cssModuleKeys
    .sort()
    .map(key => `export const ${camelCase ? camelcase(key) : key}: string;`)
    .join('\n')
    .concat('\n');
};
...
module.exports = function(content, ...rest) {
  ...
  const { mode = 'emit', camelCase } = loaderUtils.getOptions(this) || {};
